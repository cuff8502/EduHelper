...
* Version 1.3.5.0 패치 내용
- 음소거 단축키 기능 지원
- 국정 평어 순화
- 여러 가지 버그 수정

* Version 1.3.4.0 패치 내용
- 음소거 기능 지원
- 평어에서 국어, 음악 등의 작품이나 노래 제목 제거
- 평어에서 AI 를 인공지능으로 순화

* Version 1.3.3.0 패치 내용
- 메인화면 시각적 피로도 감소
- 창체 자율활동, 동아리 가나다 순 정렬 및 카테고리 분류

* Version 1.3.2.0 패치 내용
- 홍보문구 복사기능 추가
- 일부 행발 영어식 표현 순화
 
## 📌 v1.3.1(2025-11-23)
- 전학년 전교과 평어업데이트 완료
- 복사버튼 실행시 버튼 깜빡임 & 소리 추가
